...
<script>
    ...
    function showUpdate(obj){
        ...
        // 老版本是editor.customConfig.uploadImgServer， 新版本是editor.config.uploadImgServer
        editor.config.uploadImgServer = '/management/book/upload' //设置图片上传路径
    ...
    function showCreate(){
        ...
        // 老版本是editor.customConfig.uploadImgServer， 新版本是editor.config.uploadImgServer
        editor.config.uploadImgServer = '/management/book/upload';//设置图片上传地址
        editor.config.uploadFileName = 'img';//设置图片上传参数
        editor.create();//创建wangEditor
